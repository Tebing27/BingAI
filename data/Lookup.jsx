...
export default {
  SUGGSTIONS: ['Buatkan Aplikasi Catatan di React', 'Buatkan Aplikasi Lacak Keuangan', 'Buatkan Aplikasi Catatan Gula Darah', 'Buatkan Aplikasi Quizz beserta History', 'Buatkan Portofolio Modern'],
  HERO_HEADING: 'Apa yang ingin Anda buat?',
  HERO_DESC: 'Perintah, run, edit, dan deploy full-stack web app.',
  INPUT_PLACEHOLDER: 'Apa yang ingin Anda buat?',
